...
-- AddForeignKey
ALTER TABLE `CategoryContent` ADD CONSTRAINT `CategoryContent_content_id_fkey` FOREIGN KEY (`content_id`) REFERENCES `Content`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `CategoryContent` ADD CONSTRAINT `CategoryContent_category_id_fkey` FOREIGN KEY (`category_id`) REFERENCES `Category`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
